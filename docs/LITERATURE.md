...
|---|---|---|
| Heterogeneous, time-aware multi-relational GNN over customer/merchant/device/IP + focal loss for imbalance | TMR-GGNN (2026, arXiv:2606.18444) | Validates our graph tier design exactly |
...
| LLM + GCN hybrid (LLM supplies semantic features, GCN does structure) hits 0.98 acc on e-commerce payments | Luo et al. (2025, arXiv 2509.09258) | Validates our LLM-as-semantic-feature tier |
